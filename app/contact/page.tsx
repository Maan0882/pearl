    ...
    <div className="flex flex-col min-h-screen pt-20">
      ...
      <section className="py-12 md:py-20" style={{ background: "var(--bg)" }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-[2rem] overflow-hidden shadow-2xl border border-[var(--border)] relative">
            <div className="absolute -top-20 -right-20 w-80 h-80 bg-[var(--accent)] opacity-5 rounded-full blur-3xl pointer-events-none" />
            <div className="absolute -bottom-20 -left-20 w-80 h-80 bg-[var(--glow)] opacity-8 rounded-full blur-3xl pointer-events-none" />
              ...
              <div className="p-8 md:p-14 bg-white">
                <form className="space-y-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-medium text-[var(--text)] mb-1.5">First Name</label>
                      <input type="text" className="w-full px-4 py-3 rounded-xl border border-[var(--border)] focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent outline-none transition-all bg-[var(--bg)] text-[var(--text)]" placeholder="John" />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-[var(--text)] mb-1.5">Last Name</label>
                      <input type="text" className="w-full px-4 py-3 rounded-xl border border-[var(--border)] focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent outline-none transition-all bg-[var(--bg)] text-[var(--text)]" placeholder="Doe" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[var(--text)] mb-1.5">Email</label>
                    <input type="email" className="w-full px-4 py-3 rounded-xl border border-[var(--border)] focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent outline-none transition-all bg-[var(--bg)] text-[var(--text)]" placeholder="john@company.com" />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[var(--text)] mb-1.5">Product Interest</label>
                    <select className="w-full px-4 py-3 rounded-xl border border-[var(--border)] focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent outline-none transition-all bg-[var(--bg)] text-[var(--text)]">
                  ...
                  <div>
                    ...
                    <textarea rows={4} className="w-full px-4 py-3 rounded-xl border border-[var(--border)] focus:ring-2 focus:ring-[var(--accent)] focus:border-transparent outline-none transition-all bg-[var(--bg)] text-[var(--text)] resize-none" placeholder="Tell us about your requirements — quantity, destination, packaging preferences..." />
                  </div>
